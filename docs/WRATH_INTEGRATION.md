...
live history. Red Mage forecasting additionally projects Dualcast and guaranteed
proc consumption/grants, black/white mana, and mana stacks. It never invents a
random Verfire/Verstone proc: if one actually appears, the next live frame
recalculates the entire sequence from that new state. Ordinary consumables
